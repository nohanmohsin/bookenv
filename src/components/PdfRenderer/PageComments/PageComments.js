...
const PageComments = ({pageNum, data, bookID}) => {
  ...
  const submitComment = async (e) => {
    ...
    await addDoc(collection(db, `books/${bookID}/pagecomments`), {
      ...
      avatarURL: "https://yt3.ggpht.com/ytc/AKedOLQFCSVrqjFIW4_wDf-XAB60ze8RHm-zE-c3oVe0=s88-c-k-c0x00ffffff-no-rj-mo",
    ...
    <section className="page-comments">
      ...
      <form onSubmit={submitComment}>
        <img
          ...
          height={30}
        />
        <input type="text" placeholder="Comment on this Page" value={commentContent} onChange={(e) => {
